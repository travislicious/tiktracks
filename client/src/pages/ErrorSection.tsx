...
export default function ErrorSection() {
    return (
        <main className='w-screen h-screen flex flex-col gap-4 items-center justify-center'>
            ...
            <p className='text-center w-80 md:text-lg md:w-96'>An error occured. It may be your device or our servers. Please check your Internet connection and try again.</p>
